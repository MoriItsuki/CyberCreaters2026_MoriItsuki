...
namespace
{
	...
	constexpr float ITEMSIZE = 80.0f;	//アイテムのサイズ
	...
	constexpr int ITEM_MAX = 5;			//貯められるアイテムの上限
}
...
HRESULT CPlayer::Init()
{
	...
	m_pDashGauge = CDashgauge::Create(
		100.0f, 
		270.0f, 
		D3DCOLOR_XRGB(255, 0, 0), D3DCOLOR_XRGB(255, 255, 0), 
		vec3(100.0f + 20.0f, CProcess::SCREEN_HEIGHT - (100.0f + 20.0f), 0.0f)
	);
...
void CPlayer::Update()
{
	...
	//	アイテムゲージの更新
	//=============================================================
	float ratioItemgsuge = static_cast<float>(m_nItemCnt) / static_cast<float>(ITEM_MAX);
